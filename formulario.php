    ...
    <main class="formulario">
        ...
        <div class="uk-text-center container-formulario" uk-grid>
            ...
            <div class="uk-width-expand@m">
                <h5 style=" font-family: BellItalica;">Con la finalidad mantener un ambiente de paz y armonía y cumplir con el seguimiento de nuestros usuarios, dejamos a tu disposición el siguiente reporte de incidencias en caso de percibir un problema que pueda ocasionar daños a la integridad humana o propiedad. </h5>
                            ...
                            <div class="uk-width-1-2@s">
                                <div class="uk-text-center" uk-grid>
                                    <div class="uk-width-1-1@m descripcion">
                                        ...
                                        <div class="uk-width-1-1@s">
                                            <label for="ano" class="uk-flex uk-flex-left">NOTIFICO A SEGURIDAD</label>
